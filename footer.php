  ...
  <script src="js/toastr.min.js"></script>
    ...
    <?php if ($title == "Timetable"): ?>
      <script type="text/javascript" src="js/html2canvas.hertzen.com_dist_html2canvas.min.js"></script>
    ...
    <?php if ($title == "Download"): ?>
      ...
      <script src="js/pdfmake_fonts.js"></script>
